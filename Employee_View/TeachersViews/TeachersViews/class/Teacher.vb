...
Public Class Teacher
    ...
    Public Function lookUpTeacher() As BindingSource
        ...
        Try
            Dim conn As MySqlConnection = db.getMySqlConnection()
            Dim Str As String = "SELECT a.TEACHER_CODE, concat(b.LNAME,',',b.FNAME,' -',a.TEACHER_CODE) AS TEACHER_NAME FROM " & tableName & " a JOIN " & TABLE_PERSONS & " b ON b.PERSON_ID=a.PERSON_ID"
