...
Public Class SchoolClass
    ...
    Public Overloads Function all() As BindingSource
        ...
        Try
            ...
            Dim sql As StringBuilder = New StringBuilder
            sql.Append("SELECT a.CLASS_CODE,a.CLASS_NAME,a.TEACHERS_CODE,concat(c.LNAME,',',c.FNAME) AS ASSIGNED_TEACHER FROM " & tableName & " a ")
            sql.Append(" JOIN " & TABLE_TEACHERS & " b ON b.TEACHERS_CODE=a.TEACHERS_CODE")
