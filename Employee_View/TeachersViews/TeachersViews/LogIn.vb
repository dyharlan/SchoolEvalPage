Public Class LogIn
    ...
    Sub logIn()
        ...
        Dim tCode = Trim(Me.txtCode.Text)
        If tCode = Nothing Then
            MsgBox("Teacher Code cannot be empty.")
            Return
        End If

        Dim teacher As Teacher = New Teacher()
        Dim result As Boolean = teacher.isTeacherCodeExist(Me.txtCode.Text)
        If result = True Then

            Dim viewoption As New ViewOption
            viewoption.Show()
            Me.Close()
        Else
    ...
    Sub login_verify()
        ...
        Try
            ...
            Select Case CURRENT_ROLE
                ...
                'Dim result As Boolean = student.isStudentNumExist(txtCode.Text)
                'If result = True Then
                '    CURRENT_ROLE = PERSON_ROLE.student
