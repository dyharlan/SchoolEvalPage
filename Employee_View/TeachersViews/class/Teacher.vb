    ...
    Public Function lookUpTeacher() As BindingSource
        ...
        Try
            ...
            If CURRENT_ROLE = PERSON_ROLE.teacher Then
                condition = " AND a.TEACHERS_CODE='" & CURRENT_TEACHER_CODE & "' "
            End If

            Dim Str As String = "SELECT a.TEACHERS_CODE, concat(b.LNAME,',',b.FNAME,' -',a.TEACHERS_CODE) AS TEACHER_NAME FROM " & tableName & " a JOIN " & TABLE_PERSONS & " b ON b.PERSON_ID=a.PERSON_ID WHERE b.STATUS_CODE=1 " & condition
