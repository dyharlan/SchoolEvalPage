Public Class Class_List
    ...
    Sub viewDetail()
        If classBS.Count > 0 Then
            ...
            With schoolclass
                ...
                .TeacherCode1 = row.item("TEACHER_CODE")
    ...
    Private Sub ToolStripButton3_Click(sender As Object, e As EventArgs) Handles ToolStripButton3.Click
        If classBS.Count > 0 Then
            ...
            If MsgBox("Do yo want to delete " & row.item("CLASS_CODE") & "," & row.item("CLASS_NAME") & "," & row.item("TEACHER_CODE") & " ?", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                Dim schoolclass As New SchoolClass
