...
Public Class CourseAssignment
    ...
    Public Overloads Function delete() As Integer
        ...
        Try
            ...
            sql.Append(" AND TEACHER_CODE=@teacherCode")
    ...
    Public Overloads Function all() As BindingSource
        ...
        Try
            ...
            Dim sql As StringBuilder = New StringBuilder
            sql.Append("SELECT a.CLASS_CODE,a.TEACHER_CODE,a.COURSE_CODE, b.CLASS_NAME, concat(d.LNAME,',',d.FNAME) AS TEACHER, e.COURSE_NAME FROM " & tableName & " a ")
            sql.Append(" JOIN " & TABLE_CLASSES & " b ON b.CLASS_CODE=a.CLASS_CODE")
            sql.Append(" JOIN " & TABLE_TEACHERS & " c ON c.TEACHER_CODE=b.TEACHER_CODE")
