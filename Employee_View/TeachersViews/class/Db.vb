...
Public Class Db
    ...
    Function cteateTable_EvalStatus(conn As MySqlConnection)
        ...
        Try
            ...
            sql.Append("FORM_CODE INT Not NULL UNIQUE,")
            sql.Append("FOREIGN KEY(STU_NUM) REFERENCES " & TABLE_STUDENTS & "(STU_NUM),")
            sql.Append("FOREIGN KEY(TEACHERS_CODE) REFERENCES " & TABLE_TEACHERS & "(TEACHERS_CODE),")
            sql.Append("PRIMARY KEY(STU_NUM)")
    ...
    Function cteateTable_Form(conn As MySqlConnection)
        ...
        Try
            ...
            sql.Append("FORM_CODE INT Not NULL,")
            sql.Append("TEACHERS_CODE INT Not NULL,")
            sql.Append("QUESTION_NUM INT Not NULL,")
            sql.Append("QUESTION_WEIGHT INT Not NULL,")
            sql.Append("FOREIGN KEY(FORM_CODE) REFERENCES " & TABLE_EVAL_STATUS & " (FORM_CODE),")
            sql.Append("FOREIGN KEY(TEACHERS_CODE) REFERENCES " & TABLE_TEACHERS & "(TEACHERS_CODE),")
            sql.Append("UNIQUE(FORM_CODE, TEACHERS_CODE,  QUESTION_NUM)")
